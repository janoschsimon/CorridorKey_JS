...
if __name__ == "__main__":
    ...
    parser.add_argument("--dilate", type=int, default=70, help="Dilate radius on output alpha (px). Default: 70")
    parser.add_argument("--blur", type=int, default=20, help="Gaussian blur radius on output alpha (px). Default: 20")
